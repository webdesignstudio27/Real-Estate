...
if (isset($_POST['submit'])) {
    ...
    // Basic password strength check (minimum 8 characters, 1 letter, 1 number, 1 special char)
    if (!preg_match('/^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&]).{8,}$/', $new_password)) {
        ...
        $stmt->bind_param("si", $new_password, $_SESSION['user_to_reset']);
        $stmt->execute();

        $success = "Password changed successfully! <a href='login.php'>Click here to login</a>";

        // Optionally destroy session after password reset
        session_destroy();
    }
}
?>
                ...
                <div class="module form-module">
                    ...
                    <div class="form">
                        ...
                        <form method="post">
                            ...
                            <input type="submit" name="submit" id="buttn" value="Change Password">
