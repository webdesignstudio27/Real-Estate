...
if (isset($_POST['check_answer'])) {
    ...
    $stmt = $db->prepare("SELECT * FROM users WHERE email = ? AND answer = ?");
    ...
    if ($row) {
        $_SESSION['user_to_reset'] = $row['u_id']; // or store email if you prefer
                    ...
                    <div class="form">
                        ...
                        <form action="" method="post">
                            <?php if (!$emailFound): ?>
                                ...
                                <input type="submit" id="buttn" name="submit" value="Verify Email" />
                            <?php else: ?>
                            ...
                            <div style="margin-top: 10px;">
                                <a href="forgot_email1.php" style="color: #5c4ac7; font-size: 14px;">Forgot Email?</a>
                            </div>
