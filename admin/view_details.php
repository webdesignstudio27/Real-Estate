                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p><strong>Status:</strong>
                                                        <?php
                                                        $statusColor = ($row['status'] == 'available') ? 'green' : (($row['status'] == 'sold') ? 'red' : 'orange');
                                                        ?>
                                                        <span style="color: <?php echo $statusColor; ?>;"><?php echo ucfirst($row['status']); ?></span>
                                                    </p>
                                                    <button class="btn btn-info" onclick="window.location.href='all_property.php'">Back</button>
